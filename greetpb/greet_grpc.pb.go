...
type GreetServiceClient interface {
	...
	// Unary
	GreetWithDeadline(ctx context.Context, in *GreetDeadlineRequest, opts ...grpc.CallOption) (*GreetDeadlineResponse, error)
}
...
func (c *greetServiceClient) GreetWithDeadline(ctx context.Context, in *GreetDeadlineRequest, opts ...grpc.CallOption) (*GreetDeadlineResponse, error) {
...
type GreetServiceServer interface {
	...
	// Unary
	GreetWithDeadline(context.Context, *GreetDeadlineRequest) (*GreetDeadlineResponse, error)
...
func (UnimplementedGreetServiceServer) GreetManyTime(*GreetManyTimeRequest, GreetService_GreetManyTimeServer) error {
...
func (UnimplementedGreetServiceServer) GreetWithDeadline(context.Context, *GreetDeadlineRequest) (*GreetDeadlineResponse, error) {
...
func _GreetService_GreetWithDeadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetWithDeadline(ctx, req.(*GreetDeadlineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
